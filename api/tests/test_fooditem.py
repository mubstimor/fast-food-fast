...
class FoodItemViewTest(unittest.TestCase):
    ...
    def _set_up_admin_token(self):
        ...
        json={"name": "James Adkins", "email": "james@example.com",
              "password": "1234", "gender":"male", "user_type":"Admin"})
    ...
    def test_retrieve_invalidmenuitem(self):
    ...
    def test_get_all_menuitems(self):
        ...
        request = self.app.post('/api/v1/menu', \
                                json={"name": "Chicken Wings",
                                      "category": "Foods", "price":18000},
                                headers={"Authorization": self.bearer_token})
